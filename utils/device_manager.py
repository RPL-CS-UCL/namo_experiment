...
# Code copied form link below:
# https://github.com/IntelRealSense/librealsense/blob/c94410a420b74e5fb6a414bd12215c05ddd82b69/wrappers/python/examples/box_dimensioner_multicam/realsense_device_manager.py#L219
    ...
    def get_device_intrinsics(self, frames):
        ...
        for (dev_info, frameset) in frames.items():
            ...
            for key, value in frameset.items():
                device_intrinsics[serial][key] = value.get_profile(
